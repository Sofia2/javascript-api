...
In order to use the API, you'll just have to include the files
`base64.js`, `kpcore.js`, `XXTEA.js` and `sofia2-api-js-latest.js` in the static resources directory of your web application.
